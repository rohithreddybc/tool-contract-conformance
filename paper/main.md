...
**Sample sizes fall short of the pre-registration for four of six mutation operators, and the shortfall is structural, not a scoring choice.** §VII's achieved-N table shows only M-PRECOND and M-IGNARG meeting the ~25-real-tool-site target; the rest exhausted a structurally small corpus under the plan's §8 no-reuse refreeze rule, not a scoring shortfall. Achieved N is reported beside the pre-registered target in every case, never silently absorbed into a rate.
